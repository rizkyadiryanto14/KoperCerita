...
| For more information please see the backend guide:
|
...
| setting this variable to TRUE (boolean).  See the backend guide for details.
|
*/
...
| native libraries.  For more information please see the backend guide:
|
...
| See the backend guide for more info.
|
...
| 'sess_match_ip'
|
|	Whether to match the backend's IP address when reading the session data.
|
...
| checked on a submitted form. If you are accepting backend data, it is strongly
...
| helper' page of the backend guide for information regarding date handling.
|
*/
