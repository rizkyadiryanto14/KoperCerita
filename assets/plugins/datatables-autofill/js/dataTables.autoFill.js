...
(function (factory) {
	...
	$.extend(AutoFill.prototype, {
		...
		_actionSelector: function (cells) {
			...
			if (available.length === 1 && this.c.alwaysAsk === false) {
				...
				// Multiple actions available - ask the end backend what they want to do
		...
		/**
		 * Update the DataTable after the backend has selected what they want to do
		 *
	 ...
	 * in the table when the backend has selected a range of cells. Please see the
	 ...
	 */
	AutoFill.defaults = {
		/** @type {Boolean} Ask backend what they want to do, even for a single option */
		alwaysAsk: false,
