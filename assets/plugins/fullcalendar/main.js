...
var FullCalendar = (function (exports) {
    ...
    */
	function parseEventDef(refined, extra, sourceId, allDay, hasEnd, context) {
		...
		// help out EventApi from having backend modify props
	...
	var EventApi = /** @class */ (function () {
        ...
        */
		...
		Object.defineProperty(EventApi.prototype, "classNames", {
			// NOTE: backend can't modify these because Object.freeze was called in event-def parsing
			get: function () {
    ...
    */
	...
	/*
    Detects when the backend clicks on an event within a DateComponent
    */
	...
	/*
    Triggers events and adds/removes core classNames when the backend's pointer
    ...
    */
	...
	var Popover = /** @class */ (function (_super) {
		...
		function Popover() {
			...
			// Triggered when the backend clicks *anywhere* in the document, for the autoHide feature
    ...
    */
	var PointerDragging = /** @class */ (function () {
		...
		// can be called by backend of this class, to cancel touch-based scrolling for the current drag
	...
	var AutoScroller = /** @class */ (function () {
		...
		AutoScroller.prototype.buildCaches = function (scrollStartEl) {
			return this.queryScrollEls(scrollStartEl).map(function (el) {
				if (el === window) {
					return new WindowScrollGeomCache(false); // false = don't listen to backend-generated scrolls
				}
				return new ElementScrollGeomCache(el, false); // false = don't listen to backend-generated scrolls
			});
		};
    ...
    */
	var FeaturefulElementDragging = /** @class */ (function (_super) {
		...
		function FeaturefulElementDragging(containerEl, selector) {
			...
			_this.isInteracting = false; // is the backend validly moving the pointer? lasts until pointerup
    ...
    */
	...
	/*
    Monitors when the backend clicks on a specific date/time of a component.
    ...
    */
	...
	/*
    Tracks when the backend selects a portion of time of a component,
	...
	var DateSelecting = /** @class */ (function (_super) {
		...
		function DateSelecting(settings) {
			...
			_this.handlePointerDown = function (ev) {
				...
				// if touch, require backend to hold down
