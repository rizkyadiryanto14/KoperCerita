...
// Exports
			...
			var defaultOptions = {
				 ...
				 * This can be useful if you need some additional backend input before sending
				...
				/**
				 * If this is not null, then the backend will be prompted before removing a file.
				 */
   ...
   the backend interface specific stuff. Overwriting them won't break the upload
   ...
   */
			...
			var Dropzone = /*#__PURE__*/function (_Emitter) {
				...
				dropzone_createClass(Dropzone, [{
					...
					} // Can be called by the backend to remove a file
					...
					value: function _uploadData(files, dataBlocks) {
						...
						} // Let the backend add additional data if necessary
...
// incorrectly **
			...
			Dropzone.getElements = function (els, name) {
				...
				return elements;
			}; // Asks the backend the question and calls accepted or rejected accordingly
//
