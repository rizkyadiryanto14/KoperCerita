...
(function (factory) {
	...
	$.extend(ColReorder.prototype, {
		...
		/**
		 * Enable / disable end backend interaction
		 */
		...
		/**
		 * Disable end backend interaction
		 */
		fnDisable: function () {
			this.s.enable = false;
		},
		...
		"_fnMouseMove": function (e) {
			...
			if (this.dom.drag === null) {
				 ...
				 * point - this allows the backend to make small mouse movements when sorting and not have a
		...
		/**
		 * Copy the TH element that is being drags so the backend has the idea that they are actually
	...
	ColReorder.defaults = {
		...
		/**
		 * Redraw the table's column ordering as the end backend draws the column
